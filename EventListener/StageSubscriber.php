...
use MauticPlugin\IncrentaBundle\Stages;
...
class StageSubscriber extends CommonSubscriber
{
    ...
    /**
     * Check if user can add the stage (Increnta predefined stages can not be deleted)
     * @param Events\StageEvent $event
     */
    public function onStagePreSave(Events\StageEvent $event) {

        echo "<pre>"; print_r($event); echo "</pre>"; die("event");
    }
